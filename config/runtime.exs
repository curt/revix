...
#
#     PHX_SERVER=true bin/revix start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :revix, RevixWeb.Endpoint, server: true
end

config :revix, RevixWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
...
if config_env() == :prod do
  ...
  host = System.get_env("REVIX_HOST") || "example.com"

  config :revix, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
