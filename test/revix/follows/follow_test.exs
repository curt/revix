defmodule Revix.Follows.FollowTest do
  ...
  describe "refollow_changeset/1" do
    test "clears unfollowed_at and accepted_at" do
      follow = %{
        base_follow()
  ...
  describe "active?/1" do
    test "returns true when unfollowed_at is nil" do
      assert Follow.active?(%Follow{unfollowed_at: nil})
    end

    test "returns false when unfollowed_at is set" do
      refute Follow.active?(%Follow{unfollowed_at: ~U[2026-01-01 00:00:00Z]})
    end
  end
end
