defmodule RevixWeb.CoreComponents do
  @moduledoc """
      ...
      <label>
        ...
        <input
          ...
          class={[
            ...
            @errors != [] && (@error_class || "file-input-error")
          ]}
          {@rest}
        />
      </label>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RevixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RevixWeb.Gettext, "errors", msg, opts)
    end
  end
